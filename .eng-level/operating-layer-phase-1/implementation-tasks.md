...
- [x] **T1 — Add installed and portfolio diagnostics**
...
- [x] **T2 — Namespace lifecycle state by initiative**
...
- [x] **T3 — Add deterministic resume and next commands**
...
- [x] **T4 — Update contracts and documentation**
...
- [x] **T5 — Add instruction parity in clean repositories**
